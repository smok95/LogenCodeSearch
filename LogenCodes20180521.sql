...
INSERT INTO `codelist` (category,code,region1,region2,branch,area,color) VALUES ('A4',201,'서울권','강남','서강남','논현동,신사동,압구정동','ff8c8c'),
 ...
 ('G3',211,'서울권','송파','북송파','잠실동,신천동,삼전동','ff8c8c'),
...
','ff8c8c'),
 ...
 ('G4',216,'서울권','동작','동작','동작구','ff8c8c'),
 ('G4',217,'서울권','광진','광진','광진구','ff8c8c'),
 ('A3',218,'서울권','양천','동양천','목동,신월2,4,6동 *목동아파트1~7단지까지 목동임','ff8c8c'),
 ('G5',219,'서울권','강북','강북','강북구','ff8c8c'),
 ('A5',220,'서울권','관악','북관악','(구)신림동,난곡동,난향동,대학동,미성동,삼성동,서림동,서원동,신림동,신사동,신원동,조원동','ff8c8c'),
 ('G6',221,'서울권','동대문','서동대문','신설동,용두동,제기동,청량리동,회기동,이문동','ff8c8c'),
 ...
 ('A3',238,'서울권','양천','서양천','신월1,3,5,7동,신정동 * 목동아파트8~14단지까지 신정동임','ff8c8c'),
 ('G2',239,'서울권','은평','동은평','녹번동,불광동,응암동,진관동','ff8c8c'),
 ('G3',240,'서울권','송파','동송파','석촌동,송파동,방이동,오륜동,풍납동','ff8c8c'),
 ('A3',241,'서울권','강남','남강남','개포동,도곡동,수서동,세곡동,율현동,일원동,자곡동,포이동','ff8c8c'),
 ('G6',242,'서울권','동대문','남동대문','휘경동,장안동,전농동,답십리동','ff8c8c'),
 ('G6',243,'서울권','성북','동성북','상월곡동,석관동,장위동,하월곡동,종암동,길음동','ff8c8c'),
 ...
 ('E6',301,'경기권','고양','서일산','일산서구[구산동,덕이동,일산동(1,2,3동),일산동 산들마을3,5,6단지,탄현동]','fff557'),
 ('B2',302,'경기권','이천','이천','여주시,이천시','fff557'),
 ('E6',303,'경기권','부천','서부천','상1,2,3동,중1,2,3,4동','fff557'),
 ('B2',304,'경기권','성남','성남중원','중원구','fff557'),
 ('B6',305,'경기권','수원','동수원','영통구','fff557'),
 ('E3',306,'경기권','안산','서안산','단원구','fff557'),
 ('B6',307,'경기권','안양','동안양','동안구(관양동,귀인동,부림동,평안동,평촌동)','fff557'),
 ('D1',308,'경기권','의정부','의정부','의정부시','fff557'),
 ('E2',309,'경기권','파주','교하','교하동,다율동,당하동,동패동,목동동,문발동,산남동,상지석동,서패동,송촌동,신촌동,야당동,연다산동,오도동,와동동,운정동,조리읍,하지석동','fff557'),
 ('A5',310,'경기권','평택','동평택','가재동,군문동,도일동,독곡동,동삭동,모곡동,비전동,서정동,세교동,소사동,신대동,신장동,용이동,월곡동,유천동,이충동,장당동,장안동,죽백동,지산동,지제동,진위면,칠괴동,칠원동,통복동,평택동,합정동','fff557'),
 ...
 ('E3',314,'경기권','김포','김포','김포시','fff557'),
 ('D1',315,'경기권','포천','포천','포천시','fff557'),
 ('E3',316,'경기권','광명','광명','광명시','fff557'),
 ...
 ('B3',322,'경기권','화성','북화성','기배동,기산동,기안동,남양동,마도면,매송면,무송동,문호동,반월동,반정동,배양동,병점동,봉담읍,북양동,비봉면,서신면,송림동,송산동,송산면,수화동,시동,신남동,신외동,안녕동,안석동,온석동,원천동,장덕동,장전동,진안동,활초동,화산동,황계동,삼성전자 화성사업소 H1','fff557'),
...
','fff557'),
 ...
 ('B2',328,'경기권','양평','양평','양평군,여주시(금사면,산북면)','fff557'),
 ...
 ('D1',338,'경기권','동두천','동두천','동두천시,연천군','fff557'),
 ('E5',340,'경기권','인천','동부평','부평구(구산동,부개동,부평동,십정동,일신동)','fff557'),
 ('B3',341,'경기권','용인','기흥','기흥구','fff557'),
 ('B3',342,'경기권','경기광주','경기광주','경기 광주시','fff557'),
 ('B3',343,'경기권','의왕과천','의왕과천','의왕시,과천시','fff557'),
 ...
 ('E3',348,'경기권','인천','강화','강화군','fff557'),
 ('W1',349,'경기권','가평','가평','가평군','fff557'),
 ...
 ('B3',354,'경기권','성남','서분당','구미동,궁내동,금곡동,동원동,대장동,백현동,삼평동,석운동,운중동,정자동,판교동,하산운동','fff557'),
 ...
 ('B3',359,'경기권','화성','동탄','화성시 동탄면[능동,동탄동,반송동,석우동,영천동,오산동,청계동],동탄 제2신도시,삼성전자화성사업소H2,H3','fff557'),
 ('A5',360,'경기권','평택','서평택','고덕면,서탄면,안중읍,오성면,청북면,팽성읍,포승읍,현덕면','fff557'),
 ('E2',361,'경기권','고양','북일산','일산동구[문봉동,사리현동,산황동,설문동,성석동,식사동,중산동,중산동 산들마을 1,2단지,지영동,풍동]','fff557'),
 ('E6',362,'경기권','고양','남일산','일산서구[가좌동,주엽동,법곳동,대화동]','fff557'),
 ...
 ('M1',401,'충청권','대전','서대전','대전시 서구[가수원동,가장동,관저동,괴곡동,괴정동,기성동,내동,도마동,도안동,매노동,변동,복수동,봉곡동,산직동,오동,용문동,용촌동,우명동,원정동,장안동,정림동,평촌동,흑석동]','8ae249'),
 ('M8',402,'충청권','서산','서산','서산시','8ae249'),
 ('A5',403,'충청권','천안','동천안','동남구 전체,서북구 와촌동','8ae249'),
 ('M1',404,'충청권','청주','서청주','청주시 흥덕구 ''동''지역','8ae249'),
 ('A2',405,'충청권','충주','충주','충주시','8ae249'),
 ('M8',406,'충청권','보령','보령','보령시','8ae249'),
 ('M1',407,'충청권','금산','금산','금산군','8ae249'),
 ('M1',408,'충청권','논산','논산','논산시,계룡시','8ae249'),
 ...
 ('M7',415,'충청권','청주','원청주','청주시 전체 ''읍,면''지역,증평군','8ae249'),
 ...
 ('A5',421,'충청권','천안','서천안','서북구 전체(서북구 와촌동 제외)','8ae249'),
 ('M7',422,'충청권','태안','태안','태안군','8ae249'),
 ('M8',423,'충청권','부여','부여','부여군','8ae249'),
 ('M1',424,'충청권','대전','북대전','유성구','8ae249'),
 ('M7',425,'충청권','대전','남대전','대전시 동구','8ae249'),
 ('M7',426,'충청권','서천','서천','서천구','8ae249'),
 ...
 ('M7',433,'충청권','대전','대전중구','대전시 중구','8ae249'),
 ('M1',434,'충청권','대전','대전둔산','대전시 서구[둔산동,갈마동,탄방동,월평동,만년동]','8ae249'),
 ('M1',435,'충청권','청주','남청주','청주시 서원구 ''동''지역','8ae249'),
 ('M1',436,'충청권','청주','동청주','청주시 상당구 ''동''지역','8ae249'),
 ...
 ('T1',507,'경상권','경산','경산','경산시,청도군','49bce2'),
 ('A2',508,'경상권','안동','안동','안동시','49bce2'),
 ('T7',509,'경상권','사천','사천','사천시','49bce2'),
 ('T7',510,'경상권','진주','진주','진주시','49bce2'),
 ('T1',511,'경상권','통영','통영','통영시,경남 고성군','49bce2'),
 ('R7',512,'경상권','포항','북포항','북구,울릉군','49bce2'),
 ('M1',513,'경상권','상주','상주','상주시','49bce2'),
 ('A2',514,'경상권','영주','영주','영주시,봉화군','49bce2'),
 ...
 ('T1',535,'경상권','부산','금정','금정구','49bce2'),
 ('T7',536,'경상권','창원','진해','진해구','49bce2'),
 ('K1',537,'경상권','부산','남부산','남구','49bce2'),
 ('T7',538,'경상권','거제','거제','거제시,통영시 용남면(수도,어의리(어의도))','49bce2'),
 ('M1',539,'경상권','성주칠곡','성주칠곡','칠곡군,성주군','49bce2'),
 ...
 ('T5',545,'경상권','대구','남대구','달서구,*달성군 하빈면,다사읍','49bce2'),
 ...
 ('T5',555,'경상권','대구','대구달성','경북 고령군,달성군','49bce2'),
 ...
 ('W1',704,'강원권','속초','속초','속초시,양양군','d4ab3b'),
 ('L1',705,'강원권','동해','동해','동해시','d4ab3b'),
 ('L1',706,'강원권','원주','원주','원주시','d4ab3b'),
